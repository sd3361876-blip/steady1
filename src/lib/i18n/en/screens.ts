...
export const screensEn = {
  ...
  questionnaire: {
    ...
    processing: {
      winTitle: "Your Steady journey is taking shape.",
      winHint: "Here's what we're building around you.",
      winGoal: "You're working toward:",
      winMilestone: "You're on track for your first Steady milestone by {{date}}.",
      title: "We're getting Steady ready for you",
      hint: "This only takes a moment.",
      goal: "Personalizing your journey",
      startingPoint: "Preparing your first steps",
      journey: "Setting up your progress",
      proofTitle: "Trusted by people on their healing journey",
      proofHint: "From the Google Play Store.",
      rating: "4.9",
